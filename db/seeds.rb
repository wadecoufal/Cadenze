...
#
#
artist1 = create_artist({  name: 'Missy Mazzoli', bio: 'Composer'}, 'missy.jpeg', 'missy_header.jpeg')
...
# # create_artist({ name: 'Johannes Brahms', bio: 'Composer'}, 'brahms.jpeg')
#
album1 = create_album({title: 'Cathedral City', year: 2010, genre: 'Classical', artist_id: artist1.id}, 'victoire_door.jpg')
album2 = create_album({title: 'Vespers for a New Dark Age', year: 2015, genre: 'Classical', artist_id: artist1.id}, 'victoire_vespers.jpg')
...
# create_album({title: 'Arvo Pärt: Portrait', year: 1980, genre: 'Classical', artist_id: 9}, 'piete.jpg')
#
create_song({title: 'A Door in the Dark',album_id: album1.id,duration: 129}, '01+A+Door+in+the+Dark+copy.m4a')
create_song({title: 'I Am Coming for My Things',album_id: album1.id,duration: 229}, '02+I+Am+Coming+for+My+Things+copy.m4a')
create_song({title: 'Cathedral City',album_id: album1.id,duration: 312}, '03+Cathedral+City+copy.m4a')
create_song({title: 'Like a Miracle',album_id: album1.id,duration: 124}, '04+Like+a+Miracle+copy.m4a')
create_song({title: 'The Diver',album_id: album1.id,duration: 229}, '05+The+Diver+copy.m4a')
create_song({title: 'A Song for Mick Kelly',album_id: album1.id,duration: 429}, '06+A+Song+for+Mick+Kelly+copy.m4a')
create_song({title: 'A Song for Arthur Russell',album_id: album1.id,duration: 529}, '07+A+Song+for+Arthur+Russell+copy.m4a')
create_song({title: 'India Whiskey',album_id: album1.id,duration: 229}, '08+India+Whiskey+copy.m4a')
# create_song({title: 'Cercles mystérieux des adolescentes',album_id: 1,duration: 119}, 'bensound-erf.mp3')
create_song({title: 'I. Wayward Free Radical Dreams',album_id: album2.id,duration: 139}, '01+Vespers+for+a+New+Dark+Age_+I.+Wayward+Free+Radical+Dreams+copy.m4a')
create_song({title: 'II. Hello Lord',album_id: album2.id,duration: 129}, '02+Vespers+for+a+New+Dark+Age_+II.+Hello+Lord+copy.m4a')
create_song({title: 'III. Interlude',album_id: album2.id,duration: 432}, '03+Vespers+for+a+New+Dark+Age_+III.+Interlude+1+copy.m4a')
create_song({title: 'IV. Come On All You',album_id: album2.id,duration: 329}, '04+Vespers+for+a+New+Dark+Age_+IV.+Come+On+All+You+copy.m4a')
#
